...
<body>
    <div class="main-container">
        ...
        <nav class="menu">
            ...
            <button onclick="location.href='comunidad/miembros.php'">Miembros</button>
        </nav>
        ...
        <section class="content">
            ...
            <div class="info-panel">
                ...
                <p>El Proyecto XYZ es un espacio interactivo para compartir historias únicas, ya sean casos del grupo "Equemm" o narrativas paranormales, siempre con un estilo inmersivo en primera persona o tercera.</p>
                <button onclick="location.href='lore/organizaciones.php'">Organizaciones Equemm</button>
            </div>
            ...
            <div class="highlighted-content">
                ...
                <div class="highlight-box">
                    ...
                    <p><strong>Autor:</strong> Golden_Gaster</p>
                    <p>Objeto Anomalo Alfa CV-04 nivel 4 presenta errores en las siguientes secciones...</p>
