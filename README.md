...
Benvingut/da a *Projecte XYZ*, un lloc web creat per i per al grup d'amics d' *Equemm*. Aquest projecte és una plataforma per compartir i explorar històries en primera persona, inspirades en les nostres experiències úniques, jocs i aventures paranormals.  
...
- 🎭 **Estil narratiu únic:** Les històries són presentades amb un estil immersiu en primera persona.  
